...
public class OuelletEnergeticOverloadCheckConstraint extends Propagator<IntVar> {
    ...
    public OuelletEnergeticOverloadCheckConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        for (int i = 0; i < nbTasks; i++)
        {
            ...
            tasks[i] = new Task(i+1, est, lct, processingTimes[i], heights[i], 0);
        ...
        OuelletEnergeticOverloadChecker ef = new OuelletEnergeticOverloadChecker(tasks, capacity);
        OuelletEnergeticOverloadChecker nef = new OuelletEnergeticOverloadChecker(negativeTasks, capacity);
        if (!ef.isConsistent() || !nef.isConsistent()) {
