...
public class BaptisteEnergeticOverloadCheckConstraint extends Propagator<IntVar> {
    ...
    public BaptisteEnergeticOverloadCheckConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        BaptisteEnergeticOverloadChecker ef = new BaptisteEnergeticOverloadChecker(tasks, capacity);
        BaptisteEnergeticOverloadChecker nef = new BaptisteEnergeticOverloadChecker(negativeTasks, capacity);
        if (!ef.OverloadCheck() || !nef.OverloadCheck()) {
