...
public class DerrienEnergeticOverloadCheckConstraint extends Propagator<IntVar> {
    ...
    public DerrienEnergeticOverloadCheckConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        DerrienEnergeticOverloadChecker ef = new DerrienEnergeticOverloadChecker(tasks, capacity);
        DerrienEnergeticOverloadChecker nef = new DerrienEnergeticOverloadChecker(negativeTasks, capacity);
