...
public class RangeTree {
    ...
    public RangeTree(Point[] points) {
        ...
        for (int i = 0 ; i < n; i++) {
            elements[i] = new Element(points[i].getX1(), points[i].getY(), points[i].getH());
            elements[n+i] = new Element(points[i].getX2(), points[i].getY(), -points[i].getH());
        }
                ...
                for (int j = 0; j < line.size(); j++) {
                    ...
                    if (j % 2 == 1) {
                        if (line.get(j - 1) != null) {
                            c = (line.get(j) != null) ? 'A' : 'B';
                        } else {
                            if (j < line.size() && line.get(j) != null) c = 'C';
                        }
                    }
                    System.out.print(c);
                    ...
                    if (line.get(j) == null) {
                        ...
                        for (int k = 0; k < hpw; k++) {
                            System.out.print(j % 2 == 0 ? " " : "D");
                        }
                        System.out.print(j % 2 == 0 ? "E" : "F");
                        for (int k = 0; k < hpw; k++) {
                            System.out.print(j % 2 == 0 ? "D" : " ");
                        }
                    }
