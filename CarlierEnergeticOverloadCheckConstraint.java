...
public class CarlierEnergeticOverloadCheckConstraint extends Propagator<IntVar> {
    ...
    public CarlierEnergeticOverloadCheckConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        CarlierEnergeticOverloadChecker ef = new CarlierEnergeticOverloadChecker(tasks, capacity, true);
        CarlierEnergeticOverloadChecker nef = new CarlierEnergeticOverloadChecker(negativeTasks, capacity, false);
